namespace Problem4
{
    ...
    public class StartUp
    {
        ...
        private static void AddMinionVillain(
            SqlConnection connection, int? villainId,
        ...
        {
            string minionQuerySql = "SELECT Id FROM Minions WHERE Name = @Name";

            using (SqlCommand command = new SqlCommand(minionQuerySql, connection))
            {
