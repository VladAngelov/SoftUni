    ...
    public static class Deserializer
    {
        ...
        public static string ImportUsers(VaporStoreDbContext context, string jsonString)
        {
            ...
            foreach (var userDto in usersDto)
            {
                ...
                {
                    var cardType = Enum.TryParse<CardType>(cardDto.Type, out CardType typeResult);
        ...
        public static string ImportPurchases(VaporStoreDbContext context, string xmlString)
        {
            ...
            ImportPurchaseDto[] purchasesDto = (ImportPurchaseDto[])xmlSerializer
            ...
            foreach (var purchaseDto in purchasesDto)
            {
                ...
                var isValidEnum = Enum
                    .TryParse<PurchaseType>(purchaseDto.Type, out PurchaseType purchaseType);
        ...
        private static Tag GetTag(VaporStoreDbContext context, string currentTag)
        {
            var tag = context
                .Tags
                .FirstOrDefault(x => x.Name == currentTag);
        ...
        private static Genre GetGenre(VaporStoreDbContext context, string gameDtoGenre)
        {
            var genre = context
                .Genres
                .FirstOrDefault(x => x.Name == gameDtoGenre);
        ...
        private static Developer GetDeveloper(VaporStoreDbContext context, string gameDtoDeveloper)
        {
            var developer = context
                .Developers
                .FirstOrDefault(x => x.Name == gameDtoDeveloper);
